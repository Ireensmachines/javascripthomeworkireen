...
// ==========================================
const outCome3 = 4+3
const FinalOutCome3 = outCome3*7;
console.log(FinalOutCome3);

const alternativeOutcome3 = 7*4+3; // * and / before +-
console.log(alternativeOutcome3);
...
const smaak1 = "zoet ";
const smaak2 = "sappig ";
const sinaasappel = smaak1 + smaak2;
...
// ==========================================
const voornaam = "Ireen";
const achternaam = "van Wanrooij"; // hoort een spatie achter de ",maar dat mag ik niet meer doen.
...
const hierWoonIk = woonplaats + provincie;
console.log(hierWoonIk);
